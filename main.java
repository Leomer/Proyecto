...
public class main {
    ...
    public static boolean registrarproducto(){
        System.out.println("Aun no esta disponible este modulo.");
    ...
    public static int menunavegacion(){
        ...
        System.out.println("3) Registro de movimientos");
        System.out.println("4) Registro de proveedores");
        System.out.println("5) Registro de clientes");
